...
* **Game State Management:** Built a central manager to handle game loops, including scoring logic, win/loss conditions, and UI scene transitions.

* **Physics Triggers & Events:** Utilized Unity's physics engine (`OnCollisionEnter`, `OnTriggerEnter`) to drive gameplay events such as collecting items or triggering traps.
